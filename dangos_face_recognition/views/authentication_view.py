...
from ..models import UserToken, PasswordResetToken, RefreshToken
...
class AuthenticationViewSet(viewsets.ViewSet):
    ...
    def get_permissions(self):
        if self.action in ["login", "refresh_token", "reset_password"]:
            permission_classes = [AllowAny]
        elif self.action in ["activate_users"]:
        ...
        try:
            ...
            if request.method == "POST":
                ...
                context = {
                    ...
                    "app_name": "Dangos Face Recognition",
                }
    ...
    @action(detail=False, methods=["post"], url_path="activate-users")
